...
Класс `TaskDialog` в языке EME-L — класс для создания и отображения диалоговых окон Task Dialog с расширенными возможностями взаимодействия с пользователем. Предоставляет программный интерфейс к современным диалоговым окнам операционной системы, которые отображают основное сообщение, выделенную инструкцию, заголовок, стандартные и командные кнопки, радиокнопки, флажок подтверждения, область подвала и индикатор прогресса. По сравнению с обычным `MessageBox` класс `TaskDialog` предоставляет значительно более широкие возможности настройки внешнего вида и анализа выбора пользователя.
...
Используется в прикладных скриптах EME-L для организации информативных диалогов с пользователем, запроса подтверждений, выбора варианта действия из нескольких команд, отображения хода длительных операций и других сценариев, где возможностей `MessageBox` недостаточно.

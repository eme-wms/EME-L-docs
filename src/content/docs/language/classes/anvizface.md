...
Все три конструктора принимают IP-адрес, порт и идентификатор устройства; необязательные параметры задают таймаут ответа и уровень отладочного вывода библиотеки `tc-b_new_sdk.dll`.
